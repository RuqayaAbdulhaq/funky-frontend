  ...
  console.log(props);
    return (
      <div className="main-container min-h-screen text-black dark:text-white-dark navbar-sticky">
        <nav class="sidebar fixed bottom-0 top-0 z-50 h-full min-h-screen w-[255px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">

        </nav>
        <div className="ps-64 main-content flex min-h-screen flex-col">
          <header className="z-40 shadow-sm">
            <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726] min-h-[58px]">
